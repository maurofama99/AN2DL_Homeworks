...
#output = Dense(8, activation='softmax', name='Output')(class1)
...
output_layer = tfkl.Dense(units=1, activation='softmax', name='Output', 
                              kernel_initializer=tfk.initializers.GlorotUniform(seed=seed))(hidden_layer3)

    # Connect input and output through the Model class
model = tfk.Model(inputs=convnet.layers[0].input, outputs=output_layer, name='dropout_model')
